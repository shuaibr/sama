...
<!-- For checkpoint task examples and patterns, see @/home/user/sama/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/user/sama/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/user/sama/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/user/sama/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
