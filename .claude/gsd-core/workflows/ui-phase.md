...
```markdown
Read /home/user/sama/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/sama/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/sama/.claude/agents/gsd-ui-checker.md for instructions.
