...
```
Agent(
  prompt="Read /home/user/sama/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/sama/.claude/gsd-core/templates/SECURITY.md`
