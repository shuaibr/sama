...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/sama/.claude/.gsd-surface.json`
(sibling to `/home/user/sama/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/sama/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/sama/.claude/skills`).
...
`/home/user/sama/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/sama/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/sama/.claude/.gsd-surface.json`
Install profile marker: `/home/user/sama/.claude/.gsd-profile`
Skill dirs: `/home/user/sama/.claude/skills/gsd-*/`
Engine module: `/home/user/sama/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/sama/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
