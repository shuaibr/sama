...
<execution_context>
@/home/user/sama/.claude/gsd-core/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @/home/user/sama/.claude/gsd-core/workflows/mvp-phase.md end-to-end.
