...
<required_reading>
@/home/user/sama/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/sama/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/sama/.claude
                  → checks /home/user/sama/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/sama/.claude/gsd-core
                  → writes to /home/user/sama/.claude/gsd-core/hooks/
...
@/home/user/sama/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/sama/.claude/gsd-core/references/common-bug-patterns.md
